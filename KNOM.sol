...
contract KNOM is BurnableToken, DetailedERC20, ERC20Token,Pausable{
	using SafeMath for uint256;
	...
	string public constant symbol = "KNOM";
 	string public constant name = "KNOM";
	uint8 public constant decimals = 18;
	
	uint256 public constant TOTAL_SUPPLY = 6*(10**8)*(10**uint256(decimals));
